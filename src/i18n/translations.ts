...
const en = {
  ...
  hero: {
    ...
    sub: "This is not a typical webinar. It is a structured live workshop focused on market interpretation.",
    tagline: ["Walk In With Questions.", "Leave With A Clearer Approach."],
    cta: "Reserve My Free Seat",
    info: {
      date: { label: "27-07-2026", sub: "Monday" },
      time: { label: "09:00 AM", sub: "(Qatar Time)" },
      online: { label: "Online", sub: "Free to attend" },
      presenter: { label: "Presented by", sub: "Ghassan Albahtoori" },
    },
    trust: {
      regulatedTop: "Regulated across multiple jurisdictions including",
      regulatedBottom: "ASIC | FSCA | CMA | FSA | FSC",
      globalTop: "Global",
      globalBottom: "Multi-Asset Broker",
      nbaAlt: "Official Partner of the NBA",
      porscheAlt: "Porsche Carrera Cup partner",
    },
  },
  ...
  why: {
    ...
    cards: [
      ...
      "It is built to help you stop reacting to every update and start using a clearer process for what to focus on, what to ignore, and what to do next.",
    ],
  },
...
const ar: Translation = {
  ...
  hero: {
    ...
    title: {
      main: "تعرف على أهم ما يجب متابعته",
      accent: "في الأسواق",
    },
    lead: "للمهتمين بأسواق الذهب والنفط والأسواق العالمية، والراغبين في فهم أعمق لعوامل تحركات السوق.",
    sub: "هذه ندوة مباشرة ومنظمة تركز على تحليل السوق.",
    tagline: ["سنستمع إلى أسئلتكم", "ونساعدكم في الحصول على رؤية أوضح"],
    cta: "احجز مقعدك المجاني",
    info: {
      date: { label: "27-07-2026", sub: "الإثنين" },
      time: { label: "09:00 صباحًا", sub: "بتوقيت قطر" },
      online: { label: "أونلاين", sub: "حضور مجاني" },
      presenter: { label: "مقدمة من قبل", sub: "غسان البحيري" },
    },
    trust: {
      regulatedTop: "خاضع للتنظيم في عدة ولايات قضائية بما في ذلك",
      regulatedBottom: "ASIC | FSCA | CMA | FSA | FSC",
      globalTop: "وسيط عالمي",
      globalBottom: "للأصول المتعددة",
      nbaAlt: "شريك رسمي للرابطة الوطنية لكرة السلة (NBA)",
      porscheAlt: "شريك رسمي لبطولة كأس بورش كاريرا الشرق الأوسط",
    },
  },
  ...
  why: {
    ...
    subtitle: "قد تكون تحركات السوق غير مفهومة أحيانًا. نحن نساعدك في تبسيطها.",
    cards: [
      "الذهب، النفط، الدولار، العلاقة بين مختلف الأصول قد تكون صعبة الفهم.",
  ...
  who: {
    ...
    items: [
      ...
      "تفكر في خطوتك التالية وتريد مزيدًا من الوضوح أولًا",
    ],
    tags: [
      "لا يلزم معرفة متقدمة.",
      "أنت فقط بحاجة إلى طريقة أفضل للتعامل مع بيانات السوق.",
    ],
  },
  ...
  includes: {
    ...
    toolkit: "مجموعة أدوات قرارات السوق الخاصة بك",
    receives: "يحصل كل مشارك مسجل على:",
    items: [
      "تسجيل كامل للندوة",
  ...
  about: {
    title: "عن ستار تريدر",
    paras: [
      "ستار تريدر هي شركة وساطة عالمية مرخصة ومتخصصة في تداول الأصول المتعددة، توفر الوصول إلى الأسواق المالية، وتقنيات التداول، وآراء المحللين، والبرامج التدريبية.",
  ...
  final: {
    title: "الأسواق في حركة مستمرة، اعرف أهم المعلومات",
    subtitle:
