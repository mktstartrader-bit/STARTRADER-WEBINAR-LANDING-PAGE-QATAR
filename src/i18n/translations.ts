...
const ar: Translation = {
  ...
  hero: {
    ...
    lead: "ندوة للمهتمين بالذهب والنفط والدولار، لفهم أهم العوامل التي تؤثر على تحركات الأسواق وقراءة الأحداث الاقتصادية بطريقة أوضح.",
    tagline: [
  ...
  about: {
    title: "عن ستار تريدر",
    paras: [
      "ستار تريدر هي شركة عالمية مرخصة توفر إمكانية الوصول إلى أسواق متعددة، مع أدوات تداول، ودعم، ومحتوى تحليلي، وبرامج تعليمية تساعد المتداولين على متابعة الأسواق بطريقة أكثر تنظيمًا.",
  ...
  final: {
    title: "الذهب والنفط والدولار في حركة مستمرة. تعرف على ما يستحق المتابعة",
    subtitle:
